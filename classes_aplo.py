...
class Metrics:
    ...
    def rel_num_list(self):
        rq_path='/home/lefteris/Ceid/anaktisi_pliroforias/ir_2023-2024/Relevant_20'         #path
    ...
    def get_res_list(self):
        result_list=[]
        with open('/home/lefteris/Ceid/anaktisi_pliroforias/ir_2023-2024/cfquery_detailed', 'r') as file:
            values = []  
            flag = 0
...
class VSM:
    ...
    def get_query(self,n):  
        questions = []
        with open("/home/lefteris/Ceid/anaktisi_pliroforias/ir_2023-2024/Queries_20", 'r') as file:
