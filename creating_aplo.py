...
def creating_df():
    path = "/home/lefteris/Ceid/anaktisi_pliroforias/ir_2023-2024/docs"
    os.chdir(path) 

    simple_dictionary={}                                ##απλο dictionary που λεει ποσες φορες εμφανιστηκε και σε ποιο έγκραφο η καθε λεξη (οχι γραμμες)
